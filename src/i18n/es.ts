...
export const es = {
  ...
  fields: {
    ...
    wplaceCookies: "Cookies de Wplace (JSON, opcional)",
    wplaceCookiesPlaceholder: "Pega un array JSON de cookies exportadas del navegador",
    useProxy: "Usar proxy",
  ...
  messages: {
    ...
    profilesImported: "✅ Se importaron {count} perfiles",
  ...
  ui: {
    ...
    wplaceCookiesNote: "Alternativa: pega cookies completas exportadas (array JSON) para crear 1 instancia sin token manual.",
    wplaceCookiesCount: "{count} cookies detectadas",
