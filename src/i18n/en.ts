...
export const en = {
  ...
  fields: {
    ...
    wplaceCookies: "Wplace cookies (JSON, optional)",
    wplaceCookiesPlaceholder: "Paste a JSON cookies array exported from your browser",
    useProxy: "Use proxy",
  ...
  ui: {
    ...
    wplaceCookiesNote: "Alternative: paste the full exported cookies JSON array to create 1 instance without entering a token.",
    wplaceCookiesCount: "{count} cookies detected",
